...
/**
 * Class for requests client to hide the current custom keyboard and display the default letter-keyboard
 * @author alxmsl
 */
final class ReplyKeyboardHide implements JsonSerializable {
    /**
